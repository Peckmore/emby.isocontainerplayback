...
{
    /// <summary>
    /// Represents the service that handles calls to the "GetIsoDirectory" API endpoint.
    /// </summary>
    public class IsoDirectoryService : IService
    {
        #region Fields
        ...
        /// <summary>Initializes a new instance of the <see cref="IsoDirectoryService" /> service.</summary>
        /// <param name="logManager">The log manager.</param>
        public IsoDirectoryService(ILogManager logManager)
        {
            _logger = logManager.GetLogger(nameof(IsoDirectoryService));

            _logger.Info($"{nameof(IsoDirectoryService)} is started.", 0);
        }
